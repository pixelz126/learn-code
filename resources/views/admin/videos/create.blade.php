                        ...
                        <form method="post" action="{{ route('videos.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="link" id="input-link" class="form-control form-control-alternative{{ $errors->has('link') ? ' is-invalid' : '' }}" placeholder="{{ __('https://www.example.com/watch?v=wuvHO5lGVFE') }}" value="{{ old('link') }}" required>
